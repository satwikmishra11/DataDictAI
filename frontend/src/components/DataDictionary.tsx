    ...
    <div className="space-y-8 pb-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="relative">
          ...
          <select 
            className="w-full pl-12 pr-4 py-4 bg-white border border-surface-200 rounded-[20px] outline-none shadow-soft text-sm font-bold text-surface-700 appearance-none"
                    ...
                    <div className="flex items-center gap-5">
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-4 mt-1.5">
                          ...
                          <span className="flex items-center gap-1.5 text-xs font-bold text-surface-400 uppercase tracking-widest">
                            <Calendar size={12} /> Updated 12h ago
                          </span>
                        </div>
                      </div>
                    </div>
